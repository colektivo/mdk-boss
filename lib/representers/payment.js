...
var Payment = {
  compute: function(card_id, maxDevices) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      "  	AND date '2023-04-03' + (interval '5 hours') - created_at < (interval '24 hours') " +
      "  ORDER BY created_at DESC " +
      "  LIMIT 50 " +
      ") " +
      "SELECT *, " +
      ...
      return models.sequelize.query(magicQuery2,
        {
          replacements: { card_id: card_id, maxDevices: maxDevices }
